    ...
    // 指定显示页面
    {
      ...
      children: [
        "intro2planetsci.md",
        {
          ...
          link: "",
          collapsible: true,
          children: ["planet_dynamics.md", "planet_properties.md", "planet_tectonics_motion.md", "planet_igrf_intro.md", "planet_oribit.md", "planet_magneticfield.md", "planet_geomagnetic.md"],
        },
        {
          text: "🌌行星科学导论",
